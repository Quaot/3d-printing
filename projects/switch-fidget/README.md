...
[![checks](https://github.com/Quaot/3d-printing/actions/workflows/switch-fidget.yml/badge.svg)](https://github.com/Quaot/3d-printing/actions/workflows/switch-fidget.yml)
![Status](https://img.shields.io/badge/status-in_progress-yellow)
![Python](https://img.shields.io/badge/Python-3.12+-3776AB?logo=python&logoColor=white)
![build123d](https://img.shields.io/badge/CAD-build123d-informational)
![Exports](https://img.shields.io/badge/exports-STL_%7C_STEP-lightgrey)

**Status: in progress. The design is done; it hasn't been printed yet.**
